...
export interface ModalPayNotificationProps {
  show: boolean;
  problemPlans?: ProblemPlan[];
  onCloseModalPayNotification: () => void;
}
...
const ModalPayNotification: FC<ModalPayNotificationProps> = ({
  problemPlans = problemPlansDemo,
  show,
  onCloseModalPayNotification,
}) => {
    ...
    return (
      <form action="#">
        ...
        <div className="mt-4 space-x-3">
          ...
          <ButtonSecondary type="button" onClick={onCloseModalPayNotification}>
            Cancel
          </ButtonSecondary>
        </div>
      </form>
  ...
  return (
    <NcModal
      isOpenProp={show}
      onCloseModal={onCloseModalPayNotification}
