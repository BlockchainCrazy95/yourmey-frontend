...
import SortOrderFilter from "components/SectionGridAuthorBox/SortOrderFilter";
import React, { FC } from "react";
import ButtonPrimary from "shared/Button/ButtonPrimary";
import ButtonSecondary from "shared/Button/ButtonSecondary";
import Nav from "shared/Nav/Nav";

export interface SectionTopCreationsProps {
  className?: string;
...
const SectionTopCreations: FC<SectionTopCreationsProps> = ({
  className = "",
  boxCard = "box1",
  sectionStyle = "style1",
  ...
  return (
    <div
      className={`nc-SectionTopCreations relative ${className}`}
      data-nc-id="SectionTopCreations"
    >
      ...
      <div className="mt-16 flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-5">
        ...
        <ButtonPrimary>Become an artist</ButtonPrimary>
      </div>
    </div>
  );
};

export default SectionTopCreations;
