...
export interface SectionRankingsProps {
  className?: string;
  itemClassName?: string;
  cardStyle?: "style1" | "style2";
}

const SectionRankings: FC<SectionRankingsProps> = ({
  className = "",
  cardStyle = "style1",
}) => {
  ...
  return (
    <div className={`nc-SectionRankings ${className}`}>
      <Heading
...
export default SectionRankings;
